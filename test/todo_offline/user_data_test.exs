defmodule TodoOffline.UserDataTest do
  use TodoOffline.DataCase
  ...
  describe "user_document" do
    ...
    import TodoOffline.UserDataFixtures

    @invalid_attrs %{document: nil}

    test "list_user_document/0 returns all user_document" do
      user_document = user_document_fixture()
      assert UserData.list_user_document() == [user_document]
    end
